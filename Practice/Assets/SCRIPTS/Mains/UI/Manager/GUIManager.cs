...
namespace Clouds.Ultilities
{
    ...
    public class GUIManager : Singleton<GUIManager>
    {
        ...
        [BoxGroup("System")] [ReadOnly] public CanvasGUI currentPopupGUI;
        [BoxGroup("System")] [ReadOnly] public CanvasGUI popupGUIMultiScene;
    ...
    IEnumerator ISwitchCanvas(GUITEMPLATE canvas, Action onDone = null)
        {
            ...
            switch (canvas)
            {
                case GUITEMPLATE.Home:
                    ...
                    currentPopupGUI = homeCanvasObj.GetComponent<CanvasGUI>();
                    onDone?.Invoke();
                ...
                case GUITEMPLATE.Game:
                    ...
                    currentPopupGUI = gameCanvasObj.GetComponent<CanvasGUI>();
                    onDone?.Invoke();
        ...
        {   
            ...
            popupGUIMultiScene = multiSceneCanvasObj.GetComponent<CanvasGUI>();
        }
